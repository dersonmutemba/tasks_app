...
class MockNoteLocalDataSource extends _i1.Mock
  ...
  @override
  _i4.Future<String> insertNote(_i2.NoteModel? note) => (super.noSuchMethod(
        Invocation.method(
          #insertNote,
          [note],
        ),
  ...
  @override
  _i4.Future<void> updateNote(_i2.NoteModel? note) => (super.noSuchMethod(
        Invocation.method(
          #updateNote,
          [note],
        ),
...
class MockNoteRemoteDataSource extends _i1.Mock
  ...
  @override
  _i4.Future<void> insertNote(_i7.Note? note) => (super.noSuchMethod(
        Invocation.method(
          #insertNote,
          [note],
        ),
  ...
  @override
  _i4.Future<void> updateNote(_i7.Note? note) => (super.noSuchMethod(
        Invocation.method(
          #updateNote,
          [note],
        ),
